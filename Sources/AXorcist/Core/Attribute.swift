...
public struct Attribute<T> {
    ...
    public static var titleUIElement: Attribute<AXUIElement> { Attribute<AXUIElement>(AXAttributeNames.kAXTitleUIElementAttribute) }
    ...
    // public static var value: Attribute<Any> { Attribute("AXValue") } // Generic Any can be problematic, prefer specific types
    public static var valueDescription: Attribute<String> { Attribute<String>(AXAttributeNames.kAXValueDescriptionAttribute) }
    public static var valueIncrement: Attribute<NSNumber> { Attribute<NSNumber>(AXAttributeNames.kAXValueIncrementAttribute) }
    ...
    public static var window: Attribute<AXUIElement> { Attribute<AXUIElement>(AXAttributeNames.kAXWindowAttribute) } // Often the main/key window of an app element
    ...
    public static var focusedUIElement: Attribute<AXUIElement> { Attribute<AXUIElement>(AXAttributeNames.kAXFocusedUIElementAttribute) }
    ...
    // public static var hiddenApplication: Attribute<Bool> { Attribute(AXAttributeNames.kAXHiddenAttribute) } // Same as element hidden, but for app. Covered by .hidden
    public static var focusedApplication: Attribute<AXUIElement> { Attribute<AXUIElement>(AXAttributeNames.kAXFocusedApplicationAttribute) }
    ...
    public static var visibleRows: Attribute<[AXUIElement]> { Attribute<[AXUIElement]>(AXAttributeNames.kAXVisibleRowsAttribute) }
    public static var visibleColumns: Attribute<[AXUIElement]> { Attribute<[AXUIElement]>(AXAttributeNames.kAXVisibleColumnsAttribute) }
    ...
    public static var stringForRangeParameterized: Attribute<String> { Attribute<String>("AXStringForRangeParameterized") }
    public static var rangeForLineParameterized: Attribute<CFRange> { Attribute<CFRange>("AXRangeForLineParameterized") }
    public static var boundsForRangeParameterized: Attribute<CGRect> { Attribute<CGRect>("AXBoundsForRangeParameterized") }
    public static var lineForIndexParameterized: Attribute<Int> { Attribute<Int>("AXLineForIndexParameterized") }
    public static var attributedStringForRangeParameterized: Attribute<NSAttributedString> { Attribute<NSAttributedString>("AXAttributedStringForRangeParameterized") }

    // MARK: - Parameterized Table/Cell Attributes
    public static var cellForColumnAndRowParameterized: Attribute<AXUIElement> { Attribute<AXUIElement>(AXAttributeNames.kAXCellForColumnAndRowParameterizedAttribute) }
